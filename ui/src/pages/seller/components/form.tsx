...
import {ProductReal, TArea, TCategory} from '@src/lib/api-schemas';
...
export const ProductForm = ({
  ...
  const [sellType, setSellType] = useState<'rent' | 'sell'>('rent');
  ...
  const _onSubmit = handleSubmit(async (product) => {
    ...
    await onSubmit(product)?.then((product) => {
      if (!id) {
              ...
              <Controller
                ...
                render={({field}) => (
                  <Select
                    ...
                    onChange={(id) =>
                      field.onChange(
                        category.find((cat) => cat.categoryID === id),
                      )
                    }
                  />
                )}
              ...
              <Controller
                ...
                render={({field}) => (
                  <Select
                    ...
                    onChange={(id) =>
                      field.onChange(area.find((ar) => ar.areaID === id))
                    }
                  />
                )}
              />
