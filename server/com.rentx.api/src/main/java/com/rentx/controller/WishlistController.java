...
public class WishlistController {
     ...
     */
    public WishlistController(WishlistService wishlistService, UserAuthenticationProvider userAuthenticationProvider, UserRepository userRepository, ProductRealRepository productRealRepository) {
