...
public class ImageDAO implements IImageDAO {
    ...
    public List<Image> get(String type, Integer id) {
        ...
        Optional<List<Image>> result = Optional.of(images.stream().filter(image -> Objects.equals(image.getImageType(),type)
                                                    && Objects.equals(image.getId(),id)).collect(Collectors.toList()));
