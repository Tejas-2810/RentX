...
public class ElectronicGadgetService implements IElectronicGadgetsService {
    ...
    public ElectronicGadget getElectronicGadgetsDetailsById(int electronicGadgetId) {
        return electronicGadgetRepository.findById(electronicGadgetId)
                .orElseThrow(() -> new ResourceNotFoundException("electronicGadget Details with specific electronicGadgetId not found" + electronicGadgetId));
    }
