...
public class KitchenApplianceService implements IKitchenApplianceService {
    ...
    public KitchenAppliance getKitchenApplianceDetailsById(int kitchenApplianceID) {
        return kitchenApplianceRepository.findById(kitchenApplianceID)
                .orElseThrow(() -> new ResourceNotFoundException("Kitchen Appliance Details with specific Kitchen Appliance ID not found" + kitchenApplianceID));
